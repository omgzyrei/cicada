...
function Show-Menu {
    ...
    Write-Host ""
	Write-Host ""
	Write-Host "Made By .zyrei hehe"
    Write-Host "https://discord.gg/6J4vQB2gwy"
    Write-Host ""
    Write-Host ""
    Write-Host "1. Disable All Anti-Virus"
    Write-Host "2. Enable All Anti-Virus"
    Write-Host "3. Show Current Enabled Anti-Virus"
    Write-Host "4. Show System Details"
    Write-Host "5. Exit"
    Write-Host ""
}
